...
function AppContent() {
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      const currentSoundboxEnabled = state.settings.isSoundboxEnabled;
      const currentSoundboxLanguage = state.settings.soundboxLanguage;
      ...
      if (isSmsAvailable()) {
        ...
        if (smsPerms.receive) {
          ...
          await startSoundbox({
            enabled: currentSoundboxEnabled ?? true,
            language: currentSoundboxLanguage || (currentLanguage as any),
          ...
          if (isWidgetAvailable()) {
            const widgetEnabled = state.settings.isWidgetEnabled;
